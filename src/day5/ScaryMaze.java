...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		maze = ImageIO.read(getClass().getResource("Funny Maze.jpg"));
...
if(mouseColor==background){
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("273688__richerlandtv__pug-woof-2.wav"));
